...
import { ApprovalMode, EditTool, ShellTool, WriteFileTool, sessionId, logUserPrompt, AuthType, } from '@google/gemini-cli-core';
...
export async function main() {
    ...
    if (process.stdin.isTTY && input?.length === 0) {
        ...
        render(_jsx(React.StrictMode, { children: _jsx(AppWrapper, { config: config, settings: settings, startupWarnings: startupWarnings }) }), { exitOnCtrlC: false });
        return;
    }
...
async function loadNonInteractiveConfig(config, extensions, settings) {
