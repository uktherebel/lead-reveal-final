...
decomposition_prompt = ChatPromptTemplate.from_template(
      """ 
        ...
        ## Constraints (very important)
          ...
          - code: the minimal snippet introduced or refactored in this step (or the final excerpt it focuses on)
          ...
          - cognitive_load: integer 1–5 (1 = trivial recall, 5 = multi-concept integration)
